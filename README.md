...
- **لا أسرار في المستودع**: مفاتيحك تُمرَّر عبر متغير بيئة، وليست في أي ملف داخل هذا المستودع.
- **بوابة فحص ما قبل النشر**: `./tools/pre-publish-check.sh` يفحص أنماط الأسرار قبل كل دفع.
- **خطافات حماية**: ٥ خطافات تمنع الأوامر المدمّرة، وتكشف الأسرار، وتوقف هلوسة المسارات، وتمنع الحلقات اللانهائية.
...
- الأعمال المستوردة من طرف ثالث تبقى في مصادرها ولا تُوزَّع هنا — التفاصيل في [NOTICE](NOTICE.md)

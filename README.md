...
+| الأوامر         | `commands/` — ٢٤ أمراً عربياً                                                         |
+| خطوط الجودة     | `workflows/` — ١٠ خطوط (quick-check، deep-review، sprint، canary...)                  |
+| المهارات        | `skills/` — ١٧ مهارة أصلية (٧ عربية أساسية + Graphify + ٩ متخصصة للوكالة)              |
...
| [٠٦ — المرجع الشامل](docs/06-المرجع-الشامل.md)         | كل شيء: الطبقات السبع + ٢٤ أمراً + ١٠ خطوط جودة + ١٧ مهارة |
...
- الأعمال المستوردة من طرف ثالث تبقى في مصادرها ولا تُوزَّع هنا — التفاصيل في [NOTICE](NOTICE.md)
